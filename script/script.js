...
ulList.innerHTML = localStorage.getItem('TaskList');
//
...
document.querySelector('#btn-save').addEventListener('click', addLocalStorage);
function addLocalStorage() {
	let ulList = document.querySelector('#list').innerHTML.trim();
	localStorage.setItem('TaskList', ulList);
}
